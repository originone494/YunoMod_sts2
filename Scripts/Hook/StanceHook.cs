...
{
    Task OnStanceChange(PlayerChoiceContext ctx, Player player);
}

public static class StanceHook
{
    public static async Task OnStanceChange(PlayerChoiceContext ctx, Player player)         
    {
        ...
        {   
            ...
            await model.OnStanceChange(ctx, player);
